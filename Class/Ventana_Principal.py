...
class Ventana_Principal(customtkinter.CTk, tkinter.Tk):
    def __init__(self):
        ...
        self.icono_button_visualizar = tkinter.PhotoImage(
            file="icons/icon_visualizar.png"
        )
        self.icono_button_perfilamiento = tkinter.PhotoImage(
            file="icons/icon_perfil.png"
        )
        self.icono_button_editar = tkinter.PhotoImage(file="icons/icon_editar.png")

        self.sidebar_frame = customtkinter.CTkFrame(
            self, width=140, corner_radius=0, fg_color="#09184d"
        )
        self.sidebar_frame.grid(row=0, column=0, rowspan=3, sticky="nsew")
        self.sidebar_frame.grid_rowconfigure((0, 1, 2, 3), weight=1)

        self.boton_visualizar = customtkinter.CTkButton(
            self.sidebar_frame,
            command=self.click_visualizar,
            image=self.icono_button_visualizar,
            text="",
            font=font_tuple2,
            fg_color="#ffffff",
            hover_color="#7b5bf2",
        ...
        self.boton_perfilamiento_empleados = customtkinter.CTkButton(
            self.sidebar_frame,
            command=self.click_perfilamiento_empleados,
            image=self.icono_button_perfilamiento,
            text="",
            font=font_tuple2,
            fg_color="#ffffff",
            border_width=5,
        ...
        self.boton_perfilamiento_empleados.bind(
            "<Enter>", self.hover_boton_perfilar_empleados
        )
        self.boton_perfilamiento_empleados.bind(
            "<Leave>", self.leave_boton_perfilar_empleados
        )

        self.boton_editar_nomina = customtkinter.CTkButton(
            self.sidebar_frame,
            command=self.click_editar_nomina,
            image=self.icono_button_editar,
            text="",
            font=font_tuple2,
            fg_color="#ffffff",
            border_width=5,
