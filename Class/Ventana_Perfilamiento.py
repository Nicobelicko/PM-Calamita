...
from Class.Ventana_Principal import Ventana_Principal
...
class Ventana_Perfilamiento(customtkinter.CTk, tkinter.Tk):
        ...
        def __init__(self):
            ...
            self.iconphoto(False,fotosapo)
            self.geometry("600x512")
            self.configure(background="#23272a")
            self.rowconfigure(0, weight=0)
            self.columnconfigure((0,2),weight=1)

            customtkinter.CTkButton(self, image=MINIfotosapo,text="",fg_color="#23272a",state=DISABLED).grid(column=1,row=2) #imagen sapo
            ...
            self.registrobutton=customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8,command=openNewWindow, text="Registro",fg_color=buttoncolor,text_font=font_tuple2)
            self.registrobutton.grid(column=0,row=1,pady=20)
            customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8,command=helpWindow, text="Ayuda",fg_color=buttoncolor,text_font=font_tuple2).grid(column=2,row=4,pady=20)
            self.upload_data = customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8, command=openFileExplorer,text="Subir datos",state=DISABLED,fg_color=buttoncolor,text_font=font_tuple2)
            self.upload_data.grid(column=2,row=1,pady=20)
            self.clustering = customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8, command=clusteringModel, text= "Perfilar base de datos",state=DISABLED,fg_color=buttoncolor,text_font=font_tuple2)
            self.clustering.grid(column=0,row=2,pady=20)
            self.predictive = customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8, command=predictiveModel, text= "Modelo predictivo",state=DISABLED,fg_color=buttoncolor,text_font=font_tuple2)
            self.predictive.grid(column=0,row=3,pady=20)
            self.exportButton = customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8, command=exportModels, text= "Descargar bundle de modelos",state=DISABLED,fg_color=buttoncolor,text_font=font_tuple2)
            self.exportButton.grid(column=2,row=2,pady=20)
            self.exportDataButton = customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8, command=exportData, text= "Exportar el perfilado a excel",state=DISABLED,fg_color=buttoncolor,text_font=font_tuple2)
            self.exportDataButton.grid(column=2,row=3,pady=20)
            self.analisisButton = customtkinter.CTkButton(self,width=250,height=52,border_width=0,corner_radius=8, command=dataAnalysis,text="Analizar datos",state=DISABLED,fg_color=buttoncolor,text_font=font_tuple2)
